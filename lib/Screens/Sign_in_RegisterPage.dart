...
class _RegisterpageState extends State<Registerpage> {
  bool isChecked = false; // State variable for the checkbox
        ...
        child: Column(
          ...
          children: [
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Icon(FontAwesomeIcons.leaf, size: 35, color: kPraimaryColor),
                SizedBox(width: 15),
                Icon(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.pushNamed(context, SignUpRegisterPage.id);
                          },
                          child: const Text(
                            'Sign up',
                            style: TextStyle(
